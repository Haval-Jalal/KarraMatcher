...
public partial class PlayerStatisticsTests
{
    ...
    public void Databasen_HarPreciseDeTabellerViVantarOss()
    {
         ...
         *
         * CarpoolOffers tillkom i #50 och CarpoolRequests i #51. Bada ar medvetet med och
         * bar vuxnas uppgifter: erbjudandets riktning, plats, tid och platser, och
        ...
        Assert.Equal(
            [
                ...
                "NotificationPreferences", "PushSubscriptions", "RefreshTokens", "TeamRoles",
                "Teams", "Venues",
            ],
            DbSetNames());
    }
