...
public sealed record UpdateEventCommand(
    ...
    Guid EventId,
    EventDraft Draft,
    Guid ActorAccountId) : ICommand<EventDto?>;
...
{
    public Task<EventDto?> HandleAsync(CreateEventCommand command, CancellationToken cancellationToken)
    {
...
{
    public Task<EventDto?> HandleAsync(UpdateEventCommand command, CancellationToken cancellationToken)
    {
        ArgumentNullException.ThrowIfNull(command);
