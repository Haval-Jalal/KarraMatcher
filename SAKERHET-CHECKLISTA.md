...
| 12.5 | E2E-test av de fem kritiska flödena i `SPEC.md` §9 — **Playwright, full stack, kör i CI (`#71`); grönt bekräftas i första CI-körningen** | 🟡 |
...
> - **Beroende av senare issues:** 12.8 (`#72` enhetstester).
